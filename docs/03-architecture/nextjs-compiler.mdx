...
module.exports = {
  compiler: {
    ...
    styledComponents: {
      152 / 5 000
      // Fejlesztési környezetben alapértelmezés szerint engedélyezve,
      // éles környezetben letiltva a fájlméret csökkentése érdekében,
      // ennek a beállításának a beállítása felülírja az alapértelmezett beállítást minden környezetben.
      displayName?: boolean,
      // Enabled by default.
      ssr?: boolean,
      // Enabled by default.
