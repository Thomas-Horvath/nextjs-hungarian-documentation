---
title: A projekt szerkezete és felépítése
nav_title: Projeckt Felépítés
description: Ismerd meg a Next.js mappa- és fájlkonvencióit, és a projekted rendszerezésének módját.
---

Ez az oldal áttekintést nyújt a Next.js **összes** mappa- és fájlkonvenciójáról, valamint javaslatokat tesz a projekt rendszerezésére.

## Mappa- és fájlkonvenciók

### Legfelső szintű mappák

A legfelső szintű mappák az alkalmazás kódjának és statikus eszközeinek rendszerezésére szolgálnak.
...
| [`public`](/docs/app/api-reference/file-conventions/public-folder) | Statikus tartalmak, amelyeket a szerver kiszolgál        |
| [`src`](/docs/app/api-reference/file-conventions/src-folder)       | Opcionális alkalmazás forrás mappa |

### Legfelső szintű fájlok
